...
log_level = 'INFO'
work_dir = './work_dirs/gs_faster_rcnn_r50_fpn_1x_lvis_with0_bg1_tunehead'
load_from = './work_dirs/gs_faster_rcnn_r50_fpn_1x_lvis_with0_bg1/latest.pth'
resume_from = None
workflow = [('train', 1)]
