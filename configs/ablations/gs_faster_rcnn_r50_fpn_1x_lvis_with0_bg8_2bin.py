...
model = dict(
    ...
    bbox_head=dict(
        ...
        gs_config=dict(
            label2binlabel='./data/lvis/2bins/label2binlabel.pt',
            pred_slice='./data/lvis/2bins/pred_slice_with0.pt',
            fg_split='./data/lvis/2bins/valsplit.pkl',
...
log_level = 'INFO'
work_dir = './work_dirs/gs_faster_rcnn_r50_fpn_1x_lvis_with0_bg8_2bin'
