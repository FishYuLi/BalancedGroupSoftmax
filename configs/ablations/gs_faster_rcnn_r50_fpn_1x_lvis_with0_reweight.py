...
model = dict(
    ...
    bbox_head=dict(
        ...
        gs_config=dict(
            ...
            bin_cls_weight='./data/lvis/bins_cls_weight.pkl',
            others_sample_ratio=6.0,
            loss_bg=dict(
...
log_level = 'INFO'
work_dir = './work_dirs/gs_faster_rcnn_r50_fpn_1x_lvis_with0_reweight'
